...
export default function BrandSettingsPage() {
  ...
  if (userLoading && !user) {
    return (
      <main className="max-w-[1200px] mx-auto py-8 space-y-10 pb-24 animate-pulse">
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-8 px-4 md:px-0">
          <div className="space-y-2">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="h-14 bg-secondary border border-border/40 rounded-2xl" />
            ))}
          </div>
          <div className="bg-card border border-border/60 rounded-[32px] p-8 space-y-8">
            <div className="flex gap-8 items-center">
              <div className="w-28 h-28 rounded-[32px] bg-secondary shrink-0" />
              <div className="space-y-3 flex-1">
                <div className="h-5 bg-secondary rounded-lg w-32" />
                <div className="h-3 bg-secondary rounded-lg w-48" />
                <div className="h-10 bg-secondary rounded-xl w-28 mt-2" />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[1, 2, 3].map((i) => (
                <div key={i} className={cn("space-y-2", i === 3 && "md:col-span-2")}>
                  <div className="h-3 bg-secondary rounded-lg w-20" />
                  <div className={cn("bg-secondary rounded-2xl w-full", i === 3 ? "h-28" : "h-14")} />
                </div>
              ))}
            </div>
          </div>
  ...
  return (
    <main className="max-w-[1200px] mx-auto py-8 space-y-10 pb-24">
      ...
      {toast && (
        <div
          className={cn(
            "fixed top-6 right-6 z-50 flex items-center gap-3 px-5 py-3 rounded-2xl shadow-xl text-sm font-semibold",
            toast.type === "success"
            ...
            >
              <div className="p-8 space-y-10">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-8">
                  ...
                  >
                    <div className="w-28 h-28 rounded-[32px] overflow-hidden border-4 border-background shadow-xl">
                      {logoPreview ? (
                        <img
                          src={logoPreview}
                          alt="Brand logo"
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          selected
                            ...
                            : "bg-secondary/50 border-border/60 text-foreground/60 hover:text-foreground hover:bg-secondary"
                        )}
                      >
                        {cat}
                      </button>
