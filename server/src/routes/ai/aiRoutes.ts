...
import { generateImage, refinePrompt, generateProposals, generateTagline, generateEventDetails, generateBannerPrompts, generateVotingOptionPrompts } from '../../controllers/ai/aiController';
